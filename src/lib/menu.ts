...
export async function setupAppMenu() {
    ...
    const renameItem = await MenuItem.new({ text: 'Rename Note', id: 'rename-note', accelerator: 'CmdOrCtrl+R', action: () => appWindow.emit('menu-action', { action: 'rename' }) });
    ...
    const customFileItems = [newNoteItem, saveItem, deleteItem,renameItem, search ];
